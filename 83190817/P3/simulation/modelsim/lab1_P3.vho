...
-- ld_n	=>  Location: PIN_F15,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \inst3|sub|68~0_combout\ : std_logic;
SIGNAL \inst3|sub|68~1_combout\ : std_logic;
SIGNAL \inst3|sub|34~q\ : std_logic;
SIGNAL \data1~input_o\ : std_logic;
SIGNAL \inst3|sub|109~combout\ : std_logic;
SIGNAL \inst3|sub|115~0_combout\ : std_logic;
SIGNAL \inst3|sub|111~q\ : std_logic;
SIGNAL \data2~input_o\ : std_logic;
SIGNAL \inst3|sub|120~combout\ : std_logic;
SIGNAL \inst3|sub|126~0_combout\ : std_logic;
SIGNAL \inst3|sub|122~q\ : std_logic;
SIGNAL \data3~input_o\ : std_logic;
SIGNAL \inst3|sub|130~0_combout\ : std_logic;
SIGNAL \inst3|sub|137~0_combout\ : std_logic;
SIGNAL \inst3|sub|137~1_combout\ : std_logic;
SIGNAL \inst3|sub|134~q\ : std_logic;
SIGNAL \data4~input_o\ : std_logic;
SIGNAL \inst4|sub|72~combout\ : std_logic;
...
SIGNAL \inst4|sub|119~0_combout\ : std_logic;
SIGNAL \inst4|sub|126~0_combout\ : std_logic;
SIGNAL \inst4|sub|126~1_combout\ : std_logic;
SIGNAL \inst4|sub|122~q\ : std_logic;
SIGNAL \data7~input_o\ : std_logic;
SIGNAL \inst4|sub|131~0_combout\ : std_logic;
...
\inst3|sub|68~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|sub|68~0_combout\ = (\clr_n~input_o\ & (\ld_n~input_o\ & (\enable~input_o\ $ (\inst3|sub|34~q\))))
...
PORT MAP (
	...
	datad => \inst3|sub|34~q\,
	combout => \inst3|sub|68~0_combout\);

-- Location: LCCOMB_X46_Y53_N4
\inst3|sub|68~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|sub|68~1_combout\ = (\inst3|sub|68~0_combout\) # ((\clr_n~input_o\ & (!\ld_n~input_o\ & \data0~input_o\)))
...
PORT MAP (
	...
	datab => \ld_n~input_o\,
	datac => \data0~input_o\,
	datad => \inst3|sub|68~0_combout\,
	combout => \inst3|sub|68~1_combout\);
...
\inst3|sub|109\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|sub|109~combout\ = \inst3|sub|111~q\ $ (((\inst3|sub|34~q\ & \enable~input_o\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst3|sub|34~q\,
	datab => \enable~input_o\,
	datac => \inst3|sub|111~q\,
	combout => \inst3|sub|109~combout\);

-- Location: LCCOMB_X46_Y53_N18
\inst3|sub|115~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|sub|115~0_combout\ = (\clr_n~input_o\ & ((\ld_n~input_o\ & ((\inst3|sub|109~combout\))) # (!\ld_n~input_o\ & (\data1~input_o\))))
...
PORT MAP (
	dataa => \clr_n~input_o\,
	datab => \data1~input_o\,
	datac => \inst3|sub|109~combout\,
	datad => \ld_n~input_o\,
	combout => \inst3|sub|115~0_combout\);

-- Location: FF_X46_Y53_N19
\inst3|sub|111\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\inst3|sub|120\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|sub|120~combout\ = \inst3|sub|122~q\ $ (((\inst3|sub|34~q\ & (\enable~input_o\ & \inst3|sub|111~q\))))
...
PORT MAP (
	...
	datab => \enable~input_o\,
	datac => \inst3|sub|111~q\,
	datad => \inst3|sub|122~q\,
	combout => \inst3|sub|120~combout\);

-- Location: LCCOMB_X46_Y53_N12
\inst3|sub|126~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|sub|126~0_combout\ = (\clr_n~input_o\ & ((\ld_n~input_o\ & ((\inst3|sub|120~combout\))) # (!\ld_n~input_o\ & (\data2~input_o\))))
...
PORT MAP (
	...
	datab => \ld_n~input_o\,
	datac => \data2~input_o\,
	datad => \inst3|sub|120~combout\,
	combout => \inst3|sub|126~0_combout\);

-- Location: FF_X46_Y53_N13
\inst3|sub|122\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\inst3|sub|130~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|sub|130~0_combout\ = (\enable~input_o\ & (\inst3|sub|111~q\ & (\inst3|sub|34~q\ & \inst3|sub|122~q\)))
...
PORT MAP (
	...
	datab => \inst3|sub|111~q\,
	datac => \inst3|sub|34~q\,
	datad => \inst3|sub|122~q\,
	combout => \inst3|sub|130~0_combout\);

-- Location: LCCOMB_X47_Y53_N6
\inst3|sub|137~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|sub|137~0_combout\ = (\ld_n~input_o\ & (\clr_n~input_o\ & (\inst3|sub|134~q\ $ (\inst3|sub|130~0_combout\))))
...
PORT MAP (
	dataa => \ld_n~input_o\,
	datab => \inst3|sub|134~q\,
	datac => \clr_n~input_o\,
	datad => \inst3|sub|130~0_combout\,
	combout => \inst3|sub|137~0_combout\);

-- Location: LCCOMB_X47_Y53_N24
\inst3|sub|137~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|sub|137~1_combout\ = (\inst3|sub|137~0_combout\) # ((\clr_n~input_o\ & (\data3~input_o\ & !\ld_n~input_o\)))
...
PORT MAP (
	...
	datab => \data3~input_o\,
	datac => \ld_n~input_o\,
	datad => \inst3|sub|137~0_combout\,
	combout => \inst3|sub|137~1_combout\);

-- Location: FF_X47_Y53_N25
\inst3|sub|134\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\inst4|sub|72\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|sub|72~combout\ = \inst4|sub|34~q\ $ (((\inst3|sub|134~q\ & \inst3|sub|130~0_combout\)))
...
PORT MAP (
	...
	datad => \inst3|sub|130~0_combout\,
	combout => \inst4|sub|72~combout\);

-- Location: LCCOMB_X47_Y53_N22
\inst4|sub|68~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|sub|68~0_combout\ = (\clr_n~input_o\ & ((\ld_n~input_o\ & ((\inst4|sub|72~combout\))) # (!\ld_n~input_o\ & (\data4~input_o\))))
...
\inst4|sub|109\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|sub|109~combout\ = \inst4|sub|111~q\ $ (((\inst3|sub|134~q\ & (\inst4|sub|34~q\ & \inst3|sub|130~0_combout\))))
...
\inst4|sub|115~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|sub|115~0_combout\ = (\clr_n~input_o\ & ((\ld_n~input_o\ & ((\inst4|sub|109~combout\))) # (!\ld_n~input_o\ & (\data5~input_o\))))
...
\inst4|sub|119~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|sub|119~0_combout\ = (\inst4|sub|111~q\ & (\inst3|sub|134~q\ & (\inst4|sub|34~q\ & \inst3|sub|130~0_combout\)))
...
PORT MAP (
	...
	datac => \inst4|sub|34~q\,
	datad => \inst3|sub|130~0_combout\,
	combout => \inst4|sub|119~0_combout\);

-- Location: LCCOMB_X47_Y53_N28
\inst4|sub|126~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|sub|126~0_combout\ = (\ld_n~input_o\ & (\clr_n~input_o\ & (\inst4|sub|122~q\ $ (\inst4|sub|119~0_combout\))))
...
PORT MAP (
	...
	datad => \inst4|sub|119~0_combout\,
	combout => \inst4|sub|126~0_combout\);

-- Location: LCCOMB_X47_Y53_N26
\inst4|sub|126~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|sub|126~1_combout\ = (\inst4|sub|126~0_combout\) # ((!\ld_n~input_o\ & (\data6~input_o\ & \clr_n~input_o\)))
...
PORT MAP (
	...
	datab => \data6~input_o\,
	datac => \clr_n~input_o\,
	datad => \inst4|sub|126~0_combout\,
	combout => \inst4|sub|126~1_combout\);
...
\inst4|sub|131~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|sub|131~0_combout\ = ((!\inst3|sub|134~q\) # (!\inst4|sub|34~q\)) # (!\inst4|sub|111~q\)
...
PORT MAP (
	dataa => \inst4|sub|111~q\,
	datac => \inst4|sub|34~q\,
	datad => \inst3|sub|134~q\,
	combout => \inst4|sub|131~0_combout\);

-- Location: LCCOMB_X47_Y53_N16
\inst4|sub|131\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|sub|131~combout\ = \inst4|sub|134~q\ $ (((\inst4|sub|122~q\ & (!\inst4|sub|131~0_combout\ & \inst3|sub|130~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst4|sub|122~q\,
	datab => \inst4|sub|134~q\,
	datac => \inst4|sub|131~0_combout\,
	datad => \inst3|sub|130~0_combout\,
	combout => \inst4|sub|131~combout\);

-- Location: LCCOMB_X47_Y53_N20
\inst4|sub|137~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|sub|137~0_combout\ = (\clr_n~input_o\ & ((\ld_n~input_o\ & ((\inst4|sub|131~combout\))) # (!\ld_n~input_o\ & (\data7~input_o\))))
...
\inst4|sub|128\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|sub|128~combout\ = (\inst4|sub|122~q\ & (\inst4|sub|119~0_combout\ & \inst4|sub|134~q\))
